...
public class TestePessoa {
	...
	public static void main(String[] args) {
		...
		Endereco endereco = new Endereco("Minha rua", "12345", "SN", "Meu Bairro");
		EnderecoComplementar enderecocomplementar = new EnderecoComplementar(pessoa, "Endereco complementar");
